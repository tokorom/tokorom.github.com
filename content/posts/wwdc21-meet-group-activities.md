...
イベントの送信です。
イベントを送信することで、ユーザーに体験中に何が起こっているのかを知らせることができます。

再生、一時停止、スキップなどのメディア再生の体験のためのイベントは、AVPlayerやAVDelegating PlaybackCoordinatorを使っていればなにもしなくても自動的に送信されます。

もちろん、メディア再生関連以外のアプリ独自のイベントを送受信することもできます。
